...
<!--
  "Enregistrement Dossier" — champs tagués bases="A B C" et/ou
  types="DECLARATION PROLONGATION" (sous-ensemble) selon où ils
  s'appliquent ; sans attribut = partout. Regroupés en sous-sections
  repliables (.form-subsection) pour la lisibilité, le tout dans un
  seul .sybris-subform. SybrisUI.refreshFieldVisibility() (ui.js)
  bascule chaque champ individuellement selon la base/le type
  courants.
-->
<div class="sybris-subform">
    ...
    <div class="form-subsection">
        <div class="form-subsection-header" onclick="toggleSubsection(this)">
            <span class="form-subsection-icon">▾</span>
            <h6>Sinistre et période justifiée</h6>
        </div>
        <div class="form-subsection-body">
            <div class="form-container">
    ...
    <div class="form-subsection">
        <div class="form-subsection-header" onclick="toggleSubsection(this)">
            <span class="form-subsection-icon">▾</span>
            <h6>Pièces justificatives et contrôle médical</h6>
        </div>
        <div class="form-subsection-body">
            <div class="form-container">
                <jsp:include page="/WEB-INF/pages/sybris/formulaires/Commun aux bases/commun/field-select.jsp">
    ...
    <div class="form-subsection">
        <div class="form-subsection-header" onclick="toggleSubsection(this)">
            <span class="form-subsection-icon">▾</span>
            <h6>Naissance et codes techniques</h6>
        </div>
        <div class="form-subsection-body">
            <div class="form-container">
                <jsp:include page="/WEB-INF/pages/sybris/formulaires/Commun aux bases/commun/field-text.jsp">
